...
public class BSTDemoFrame extends javax.swing.JFrame {
            ...
            .addGroup(pnlConfigurationLayout.createSequentialGroup()
                .addGroup(pnlConfigurationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlConfigurationLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(AddRan, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        if (txtNodeValue.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter value for the node before add or add randomize value");
            return;
        }
        int data = Integer.parseInt(txtNodeValue.getText());
        p.addNode(data);
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        if (node == null) {
            TraversalResult.setText("The node '" + txtNodeValue.getText() + "' is not found!");
            JOptionPane.showMessageDialog(this, "The node '" + txtNodeValue.getText() + "' is not found!");
        } else {
            TraversalResult.setText("The node '" + txtNodeValue.getText() + "' is found in the BST: " + this.tree.getTraversalResult());
            p.drawPath();
